    ...
    <div class="container-fluid">
        <form action="{{route('panel/payment/create')}}" method="POST" id="" class="form-horizontal">
                            ...
                            <div class="row">
                                ...
                                <label for="month_rb" class="col-sm-11">
                                    ...
                                    <div class="col-xs-12 col-sm-5">
                                        <h2 class="text-warning"><strong>${{$monthly_price}}/mo</strong></h2>
                                    </div>
                                </label>
                            </div>
                            <hr>
            ...
            <div class="row">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h3><i class="glyphicon glyphicon-plus-sign"></i> Your Bot Server Details({{$title}})</h3>
                    </div>
                    <div class="ibox-content">
                        <div class="panel">
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="table-responsive m-t">
                                        ...
                                        <hr>
                                        <div class="">
                                            <button class="btn btn-primary pull-right"><i class="fa fa-dollar"></i>
                                                Make A Payment
                                            </button>
                                            <a href="{{route('panel/addserver')}}" class="btn btn-white"><i
